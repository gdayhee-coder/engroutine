      ...
      <div style={{ maxWidth:720, margin:"0 auto", padding:"20px 20px 40px" }}>
        ...
        <div style={{ display:"grid", gap:12, marginBottom:18 }}>
          ...
          <a href={LINK_AR} target="_blank" rel="noopener noreferrer"
            style={{ display:"flex", alignItems:"center", gap:14, background:C.paper, border:`1.5px solid ${C.border}`, borderLeft:`7px solid ${C.gold}`, borderRadius:14, padding:"18px 18px", textDecoration:"none", boxShadow:"2px 3px 0 rgba(255,122,92,0.12)" }}>
            {Ic.quiz(C.gold, 34)}
            <div style={{ flex:1 }}>
